...
import DeleteConfirmModal, {type DeleteConfirmModalRef} from "../../components/ui/form/DeleteConfirmDialog.tsx";
    ...
    return (
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6">
            ...
            <Link
                ...
                hover:bg-pink-200 transition mb-3"
            >
                            ...
                            <TableRow key={category.id}>
                                ...
                                <TableCell className="py-3">
                                    <Space size="middle">
                                        ...
                                        <Button danger icon={<CloseCircleFilled />} onClick={() => modalRef.current?.open(category.id)} />                                    </Space>
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
