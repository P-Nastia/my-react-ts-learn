...
const CategoriesEditPage: React.FC = () => {
    ...
    //@ts-expect-error -- означає, що програма буде ігнорувати і не підкреслювати наступний рядок
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6">
            ...
            <div className="max-w-full overflow-x-auto">
                ...
                >
                    ...
                    <ImageUploadFormItem name="imageFile" label="Нове фото" src={`${APP_ENV.IMAGES_400_URL}${category.image}`}  />
